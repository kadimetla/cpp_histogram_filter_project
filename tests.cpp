...
void show_grid(vector < vector <char> >);
void show_grid(vector < vector <float> >);
bool close_enough(vector<vector<float> >, vector<vector<float>>);
vector<vector<char> > read_map(string file_name);
bool close_enough(float v1, float v2);
vector<vector<float> > blur(vector<vector<float>>, float blurring);
vector<vector<float> > normalize(vector<vector<float>>);
